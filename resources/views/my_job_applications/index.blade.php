        ...
        <x-job-card :job="$application->job">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    @if(!!($application->job->job_applications_count - 1))
                    <div>
                        Other {{$application->job->job_applications_count - 1}} {{Str::plural('applicant', $application->job->job_applications_count - 1)}} applied this job
                    </div>
                    @endif
                    <div>
